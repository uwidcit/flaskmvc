...
def workout_page():
    ...
    return render_template('workout.html',all_workouts=all_workouts)
...
# @workout_views.route("/muscle_type",methods=['GET'])
# def get_workout_type(param):
#     data=request.form
#     muscles=fetch_muscle(data['Muscles'])
#     arr=[]
#     for item in data:
