...
class Workout(db.Model):
    ...
    beginner_sets=db.Column(db.String(20),nullable=False)
    intermediate_sets=db.Column(db.String(20),nullable=False)
    expert_sets=db.Column(db.String(20),nullable=False)
    equipment=db.Column(db.String(20),nullable=False,default=None)
